...
echo 'alias hiway="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/kgh2927845/ark-hiway-core.git" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/kgh2927845/ark-hiway-core.git'"
...
rm -rf "$HOME/.config/@hiway"
rm -rf "$HOME/.config/@hiway"
rm -rf "$HOME/.config/hiway-core"
